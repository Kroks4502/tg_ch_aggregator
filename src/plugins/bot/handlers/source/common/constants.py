...
QUESTION_SELECT_NEW_CATEGORY = "Ты **меняешь категорию** у источника. Выбери новую категорию:"

SUCCESS_ACTION_MODE_SWITCHING_TEXT = "переключен в режим {} сообщений"

# ERROR

ERROR_JOIN_CHAT_FAILED = ERROR_TEXT.format(text="Основной клиент не может подписаться на канал")
